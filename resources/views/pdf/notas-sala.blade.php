...
<head>
    ...
    <style>
        ...
        .pink { background:#ffd1e6; color:#a31164; }
        .gray { background:#eee; color:#333; }
        .green { background:#d6f5d6; color:#1b7a1b; }
        .muted { color:#666; }
        ...
        .grid th { text-align:left; font-size:11px; color:#666; padding:6px 8px; border-bottom:1px solid #ddd; }
        .grid td { padding:8px; vertical-align:top; }
        .row { display:flex; gap:12px; margin-top: 8px; }
        .card { border:1px solid #e5e7eb; border-radius:10px; padding:10px 12px; flex:1; }
