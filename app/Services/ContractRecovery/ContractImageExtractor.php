...
use App\Support\RecoveryDocumentPath;
...
TXT;
    ...
    protected function resolveLocalCopy(string $relativePath): LocalCopy
    {
        ...
        // Ficheros de trabajo internos (disco 'local' y lotes antiguos sueltos en
        // storage/app/…), fuera del almacén de documentos: siguen siendo locales.
        return LocalCopy::existing(
            RecoveryDocumentPath::absolute($relativePath)
