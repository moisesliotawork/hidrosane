...
namespace App\Filament\Gerente\Resources\BusquedaCpResource\Pages;

use App\Filament\Gerente\Resources\BusquedaCpResource;
...
class BuscarCp extends Page implements Forms\Contracts\HasForms
{
    ...
    protected static string $view = 'filament.gerente.resources.busqueda-cp.buscar-cp';
