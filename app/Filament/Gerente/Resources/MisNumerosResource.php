...
use App\Filament\Gerente\Resources\MisNumerosResource\Pages;
...
class MisNumerosResource extends Resource
{
    ...
    {
        $q = parent::getEloquentQuery()->with(['customer', 'comercial', 'companion', 'repartidor', 'repartidor2', 'reparto']);

        return auth()->user()?->hasRole('repartidor')
