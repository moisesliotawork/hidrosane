...
namespace App\Filament\Admin\Resources\BusquedaCpResource\Pages;

use App\Filament\Admin\Resources\BusquedaCpResource;
...
class BuscarCp extends Page implements Forms\Contracts\HasForms
{
    ...
    protected static string $view = 'filament.admin.resources.busqueda-cp.buscar-cp';
