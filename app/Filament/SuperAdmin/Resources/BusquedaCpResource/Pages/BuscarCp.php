...
namespace App\Filament\SuperAdmin\Resources\BusquedaCpResource\Pages;

use App\Filament\SuperAdmin\Resources\BusquedaCpResource;
...
class BuscarCp extends Page implements Forms\Contracts\HasForms
{
    ...
    protected static string $view = 'filament.jefe-sala.resources.busqueda-cp.buscar-cp';
